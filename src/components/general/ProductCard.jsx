            ...
            <div id="productCard-details" className="flex justify-between items-center mt-6">
                ...
                (
                        <div id="details-quantity" className="flex items-center">
                            ...
                            <input type="number" name="" id="" value={quantity} placeholder="Cantidad" min={0} className="w-4/6 ml-1 px-2 py-2 rounded-md bg-white shadow-md 
                            text-black font-medium font-paragraph text-xs placeholder-slate-400 border-black border-x-2 border-y-2" 
                        ...
                        <div id="details-quantity" className="flex items-center">
                            ...
                            2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v2.25A2.25 2.25 0 006 10.5zm0 9.75h2.25A2.25 2.25 0 0010.5 18v-2.25a2.25 2.25 0 00-2.25-2.25H6a2.25 2.25 0 00-2.25 
                            2.25V18A2.25 2.25 0 006 20.25zm9.75-9.75H18a2.25 2.25 0 002.25-2.25V6A2.25 2.25 0 0018 3.75h-2.25A2.25 2.25 0 0013.5 6v2.25a2.25 2.25 0 002.25 2.25z"/></svg>
                            <h3 className="ml-1 text-sm text-center text-black font-paragraph font-semibold"> Stock </h3>
                            <h3 className="ml-1 mr-5 text-sm text-center text-black font-paragraph"> 0 </h3>
                        </div>
                    )
                }
