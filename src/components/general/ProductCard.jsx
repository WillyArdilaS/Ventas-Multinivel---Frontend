...
const ProductCard = ({info}) => {
    ...
    return (
        <article id="productCard" className="w-1/6 flex flex-col items-center mx-auto mt-16 px-6 bg-white shadow-md rounded-md">
            <img src={info.ruta_imagen} alt="Imagen de la tarjeta" id="giftCardImage" width="200" 
            ...
            <div id="productCard-details" className="flex justify-between items-center mt-6">
                ...
                <div id="details-price" className="flex items-center">
                    ...
                    <h3 className="ml-1 text-base text-center text-black font-paragraph"> {info.precio} </h3>
                </div> 
            </div>  
            ...
            text-sm text-center border-yellow border-x-2 border-y-2 rounded-lg hover:bg-white hover:text-yellow transition-colors" onClick={onAdd}>
