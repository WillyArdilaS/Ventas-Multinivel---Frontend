...
const Graphics = () => {
  ...
  const ShowGraphic = () => {
    if (typeStatistic != '' && period != '') {
      ...
      return(<div className={`flex items-center justify-center mt-12 px-10 py-5 bg-yellow text-white text-lg font-medium font-subtitle rounded-md shadow-md`}
      role="alert">
  ...
  return (
    <>
        ...
        <section id="form-configuration" className="container flex justify-center pt-5">
      ...
      <section id="graphic" className="container flex justify-center">
