                ...
                <form action="" id="userRegister-form" className="mt-6">
                    ...
                    <div className="w-4/5 flex justify-between mx-auto">
                        ...
                        <div id="form-idNumber">
                            ...
                            <input type="text" name="idNumber" id="idNumber" value={idNumber} placeholder="Número ID" className="w-32 lg:w-44 sm:w-44 mb-6 px-3 py-2 rounded-md bg-white shadow-md 
                            text-black font-medium font-title placeholder-slate-400" onChange={(e) => setIdNumber(e.target.value)} required/>
                        </div>
                    </div>
                    <div className="w-4/5 flex justify-between mx-auto">
                        <div id="form-name">
                            <label htmlFor="name"></label>
                            <input type="text" name="name" id="name" value={name} placeholder="Nombre" className="w-32 lg:w-44 sm:w-44 mb-6 px-3 py-2 rounded-md bg-white shadow-md text-black 
                            font-medium font-title placeholder-slate-400" onChange={(e) => setName(e.target.value)} required/>
                        </div>

                        <div id="form-lastName">
                            <label htmlFor="lastName"></label>
                            <input type="text" name="lastName" id="lastName" value={lastName} placeholder="Apellido" className="w-32 lg:w-44 sm:w-44 mb-6 px-3 py-2 rounded-md bg-white shadow-md 
                            text-black font-medium font-title placeholder-slate-400" onChange={(e) => setLastName(e.target.value)} required/>
                        </div>
                    </div>
                    ...
                    <div className="w-4/5 flex justify-between mx-auto">
                        <div id="form-city">
                            ...
                            <input type="text" name="city" id="city" value={city} placeholder="Ciudad" className="w-32 lg:w-44 sm:w-44 mb-6 px-3 py-2 rounded-md bg-white shadow-md text-black 
                            font-medium font-title placeholder-slate-400" onChange={(e) => setCity(e.target.value)} required/>
                        </div>

                        <div id="form-address">
                            <label htmlFor="address"></label>
                            <input type="text" name="address" id="address" value={addres} placeholder="Dirección" className="w-32 lg:w-44 sm:w-44 mb-6 px-3 py-2 rounded-md bg-white shadow-md 
                            text-black font-medium font-title placeholder-slate-400" onChange={(e) => setAddress(e.target.value)} required/>
                        </div>
                    </div>
                    ...
                    <div className="w-4/5 flex justify-between mx-auto">
                        <div id="form-contractDate" className="flex w-full mb-6 px-3 py-2 rounded-md bg-white 
                            ...
                            <input type="date" name="contractDate" id="contractDate" value={contractDate} className="ml-12 text-black" onChange={(e) => setContractDate(e.target.value)} required/>
                        </div>   
                    </div>
                    ...
                    <div className="w-4/5 flex justify-between mx-auto">
                        <div id="form-region">
                            ...
                            font-medium font-title placeholder-slate-400" onChange={(e) => setRegion(e.target.value)} required>
                                <option value="" disabled selected hidden> Región </option>
                        ...
                        <div id="form-phoneNumber">
                            ...
                            <input type="text" name="phoneNumber" id="phoneNumber" value={phoneNumber} placeholder="Número de Teléfono" className="w-32 lg:w-44 sm:w-44 mb-6 px-3 py-2 rounded-md bg-white shadow-md 
                            text-black font-medium font-title placeholder-slate-400" onChange={(e) => setPhoneNumber(e.target.value)} required/>
                        </div>
                    </div>
                    ...
                    <div id="form-email" className="flex justify-center">
                        ...
                        <input type="email" name="email" id="email" value={email} placeholder="Correo electrónico" className="w-4/5 mb-6 px-3 py-2 rounded-md bg-white shadow-md text-black 
                        font-medium font-title placeholder-slate-400" onChange={(e) => setEmail(e.target.value)} required/>
                    </div>
                
                    <div id="form-password" className="flex justify-center">
                        <label htmlFor="password"></label>
                        <input type="password" name="password" id="password" value={password} placeholder="Contraseña" className="w-4/5 mb-6 px-3 py-2 rounded-md bg-white shadow-md text-black 
                        font-medium font-title placeholder-slate-400" onChange={(e) => setPassword(e.target.value)} required/>
                    </div>

                    <div id="form-confirmPassword" className="flex justify-center">
                        <label htmlFor="confirmPassword"></label>
                        <input type="password" name="confirmPassword" id="confirmPassword" value={passwordConfirmation} placeholder="Confirmar contraseña" className="w-4/5 px-3 py-2 rounded-md bg-white shadow-md 
                        text-black font-medium font-title placeholder-slate-400" onChange={(e) => setPasswordConfirmation(e.target.value)} required/>
                    </div>
