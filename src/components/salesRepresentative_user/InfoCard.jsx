const InfoCard = () => {
    ...
    return (
        <main className="container flex justify-center mx-auto mt-20">
            <article id="infoCard" className="w-1/4 py-8 absolute rounded-2xl bg-gradient-to-b from-lightBlue to-darkBlue">     
                ...
                <section className="flex justify-center mt-2">
                    <input type="button" id="button-changeRV" value="Cambiar representante" onClick={handleCreateUser}
