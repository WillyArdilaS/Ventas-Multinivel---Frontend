...
const LateralMenuClient = ({setUser, gradient, color}) => {
    ...
    return (
        <article className={`fixed w-1/6 h-full top-0 left-0 bg-gradient-to-b ` + gradient}>
            ...
            <section className="flex flex-col justify-around items-center h-2/5 mt-12">
                ...
                shadow-lg text-${color} text-sm font-semibold font-title hover:cursor-pointer hover:bg-transparent hover:text-white transition-colors`}> 
                    ...
                    <span className="ml-2"> Representate </span> 
                </button>   
            </section>
...
export default LateralMenuClient